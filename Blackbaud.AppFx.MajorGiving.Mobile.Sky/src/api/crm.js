...
(function () {
    ...
    .factory("frogApi", ["infinityUtilities", "infinityAuth",
        "apiPortfolio", "apiProspectView", "apiContactReportOptions", "apiContactReport", "infinityProduct",
        'customizable',
        function (infinityUtilities, infinityAuth,
            apiPortfolio, apiProspectView, apiContactReportOptions, apiContactReport, infinityProduct,
            customizable) {
