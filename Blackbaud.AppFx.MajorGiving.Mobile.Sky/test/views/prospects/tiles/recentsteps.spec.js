...
(function () {
    ...
    describe('recent steps', function () {
        ...
        function initializeController() {
            ...
            controller = $controller("RecentStepsController", {
                $scope: $scope,
        ...
        describe("RecentStepsController", function () {
            ...
            describe("basic functionality", function () {
                ...
                it("initialize sets expected values and loads the steps", function (done) {
                    ...
                    expect($scope.frogResources.recentsteps_tile_header).toBe("Recent steps/interactions");
                    ...
                    expect($scope.locals.recentSteps).not.toBeDefined("recentSteps");
                    ...
                    setTimeout(function () {
                        ...
                        expect($scope.locals.loadError).not.toBeDefined("loadError");
                        expect($scope.locals.recentSteps).toEqual(steps);
